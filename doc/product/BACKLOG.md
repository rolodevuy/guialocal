...
- [x] Base de datos y modelos (Pasos 4–7 ✅)
  - [x] Modelo Categoria (Paso 4 ✅)
  - [x] Modelo Zona (Paso 5 ✅)
  - [x] Modelo Negocio (Paso 6 ✅)
  - [x] Modelo Consulta (Paso 7 ✅)
- [x] Seeders de datos de prueba (Paso 8 ✅)
- [x] Resources Filament: Categoria, Zona, Negocio, imágenes (Pasos 9–12 ✅)
  - [x] CategoriaResource (Paso 9 ✅)
  - [x] ZonaResource (Paso 10 ✅)
  - [x] NegocioResource (Paso 11 ✅)
  - [x] Imágenes Negocio (Paso 12 ✅)
- [x] Layout principal y rutas públicas (Pasos 13–14 ✅)
- [x] Página home (Paso 15 ✅)
- [x] Listado de negocios con filtros (Paso 16 ✅)
...
- [x] Página "quiénes somos" (Paso 21 ✅)
