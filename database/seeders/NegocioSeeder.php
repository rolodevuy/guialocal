...
class NegocioSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Límites geográficos (lat_sur, lat_norte, lng_oeste, lng_este)
        // para generar coordenadas realistas dentro de cada zona
        $bounds = [
        ...
        // Genera lat/lng aleatorio dentro de los límites de la zona
        ...
        foreach ($negocios as $data) {
            ...
            Negocio::create(array_merge($data, $coord($zonaSlug), [
