        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-1.5 font-extrabold hover:opacity-90 transition-opacity leading-none">
                    ...
                    <span class="text-amber-500 text-lg">GUÍA</span><span class="text-gray-900 text-xl ml-0.5">LOCAL</span>
                </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <div class="flex items-center gap-1.5 font-extrabold mb-3 leading-none">
                        ...
                        <span class="text-amber-400 text-base">GUÍA</span><span class="text-white text-lg ml-0.5">LOCAL</span>
                    </div>
