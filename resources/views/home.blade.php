...
<section id="hero" class="bg-gray-50 relative">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-20 sm:pb-24 text-center">
        ...
        {{-- Compartir esta guía --}}
        <div class="flex items-center justify-center gap-2 mt-8" x-data="{ copied: false }">
            <span class="text-xs text-gray-400 font-medium mr-1">Compartir</span>
            <a href="https://wa.me/?text={{ urlencode('Guía Local — Tu barrio en un solo lugar ' . url('/')) }}"
            ...
            <a href="https://twitter.com/intent/tweet?text={{ urlencode('Guía Local — Tu barrio en un solo lugar') }}&url={{ urlencode(url('/')) }}"
               target="_blank" rel="noopener"
